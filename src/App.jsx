                ...
                <div className="bg-white/5 p-4 rounded-3xl border border-white/10">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <select 
                            ...
                            className="flex-1 bg-black/40 text-white px-4 py-2.5 rounded-xl text-sm font-bold border border-white/20 outline-none cursor-pointer appearance-none hover:border-white/40 focus:border-blue-400 transition-all"
