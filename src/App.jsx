...
export default function YamsUltimateLegacy() {
  ...
  * { font-family: 'Outfit', sans-serif; }
  ...
  @keyframes trophy-float-3d{0%,100%{transform:translateY(0) rotateY(0deg)}25%{transform:translateY(-15px) rotateY(90deg)}50%{transform:translateY(0) rotateY(180deg)}75%{transform:translateY(-10px) rotateY(270deg)}}
...
`}</style>
          ...
          <div className="modal-content w-full max-w-sm">
            <div className="bg-gradient-to-b from-yellow-600 to-yellow-900 rounded-[40px] p-1 shadow-[0_0_60px_rgba(234,179,8,0.4)] glow-anim">
              <div className="bg-slate-900 rounded-[38px] overflow-hidden p-5 text-center relative max-h-[85vh] overflow-y-auto">
                  ...
                  <div className="text-5xl mb-1 relative z-10" style={{animation:'fade-in-scale 0.4s cubic-bezier(0.34,1.56,0.64,1) 0.25s backwards'}}>{playerAvatars[getWinner()[0]]||'👤'}</div>
                  <div className="text-3xl font-black uppercase mb-3 relative z-10 text-white winner-glow" style={{animation:'victory-text 0.6s cubic-bezier(0.34,1.56,0.64,1) 0.3s backwards'}}>{getWinner()[0]}</div>
                  ...
                  {(()=>{
                      ...
                      <div className="grid grid-cols-3 gap-2 mb-4 relative z-10">
                          <div className="bg-white/10 p-2 rounded-xl border border-white/5" style={{animation:'fade-in-scale 0.4s ease-out 0.4s backwards'}}><div className="text-lg font-black text-white">{total}</div><div className="text-[8px] uppercase text-yellow-100 font-bold">Points</div></div>
                          <div className="bg-white/10 p-2 rounded-xl border border-white/5" style={{animation:'fade-in-scale 0.4s ease-out 0.45s backwards'}}><div className="text-lg font-black text-white">{gap>0?'+'+gap:'='}</div><div className="text-[8px] uppercase text-yellow-100 font-bold">Écart</div></div>
                          <div className="bg-white/10 p-2 rounded-xl border border-white/5" style={{animation:'fade-in-scale 0.4s ease-out 0.5s backwards'}}><div className="text-sm font-black text-white">{hasBonus?'✅':'❌'}</div><div className="text-[8px] uppercase text-yellow-100 font-bold">Bonus</div></div>
                          <div className="bg-white/10 p-2 rounded-xl border border-white/5" style={{animation:'fade-in-scale 0.4s ease-out 0.55s backwards'}}><div className="text-sm font-black text-white">{zeros}</div><div className="text-[8px] uppercase text-yellow-100 font-bold">Zéros</div></div>
                          <div className="col-span-2 bg-white/10 p-2 rounded-xl border border-white/5" style={{animation:'fade-in-scale 0.4s ease-out 0.6s backwards'}}><div className="text-xs font-black text-white">{bestCat.icon} {bestCat.name} — {bestScore}</div><div className="text-[8px] uppercase text-yellow-100 font-bold">Meilleur coup</div></div>
                      </div>);
                  })()}
                  {players.length > 1 && (
      ...
      <div className="max-w-7xl mx-auto space-y-4">
        {/* HEADER + TABS */}
        <div className={'bg-gradient-to-br '+T.card+' backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl '+T.glow+' p-4 sm:p-6 '+(theme==='glass'?'liquid-glass-card relative':'')}>
          ...
          <div className="flex gap-2 mt-4 flex-wrap sticky bottom-0 z-30 py-3 -mx-4 sm:-mx-6 px-4 sm:px-6 -mb-4 sm:-mb-6 rounded-b-3xl" style={{background:'linear-gradient(to top, rgba(0,0,0,0.85) 60%, transparent)',backdropFilter:'blur(16px)'}}>
            <button onClick={()=>switchTab('game')} className={'flex-1 min-w-[80px] py-3 rounded-xl font-bold transition-all duration-300 hover-float active:scale-95 btn-ripple '+(currentTab==='game'?'text-white shadow-xl scale-[1.02] '+T.glow:'bg-white/5 text-gray-400 hover:bg-white/15 border border-white/10 hover:text-white hover:border-white/20')} style={currentTab==='game'?{background:'linear-gradient(135deg,'+T.primary+','+T.secondary+')'}:{}}>🎮 Partie</button>
        ...
        {currentTab === 'gages' && (
            <div className={"space-y-4 tab-slide-"+tabDirection}>
                <div className={'bg-gradient-to-br '+T.card+' backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl '+T.glow+' p-6 '+(theme==='glass'?'liquid-glass-card relative':'')}>
        ...
        {currentTab==='trophies'&&(
            <div className={"space-y-4 tab-slide-"+tabDirection}>
                <div className={'bg-gradient-to-br '+T.card+' p-6 rounded-3xl border border-white/10 '+(theme==='glass'?'liquid-glass-card relative':'')}>
            ...
            <div className={"space-y-4 tab-slide-"+tabDirection}>
                <div className={'bg-gradient-to-br '+T.card+' backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl '+T.glow+' p-6'}>
                    ...
                    <div className="space-y-4 text-gray-300 text-sm">
                        <div className="bg-gradient-to-br from-white/[0.07] to-white/[0.02] p-5 rounded-2xl border border-white/10 hover:border-white/20 transition-all duration-300 hover-lift relative overflow-hidden" style={{animation:"card-appear 0.4s ease-out 0.1s backwards"}}><div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-bl from-white/5 to-transparent rounded-bl-3xl pointer-events-none"></div><h3 className="font-bold text-white mb-2 text-base flex items-center gap-2"><span className="text-2xl">🎯</span> Objectif</h3><p className="text-gray-300 text-sm leading-relaxed">Marquer le plus de points en réalisant des combinaisons. Le perdant de la partie précédente commence la suivante !</p></div>
                        <div className="bg-gradient-to-br from-white/[0.07] to-white/[0.02] p-5 rounded-2xl border border-white/10 hover:border-white/20 transition-all duration-300 hover-lift relative overflow-hidden" style={{animation:"card-appear 0.4s ease-out 0.2s backwards"}}><div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-bl from-white/5 to-transparent rounded-bl-3xl pointer-events-none"></div><h3 className="font-bold text-white mb-2 text-base flex items-center gap-2"><span className="text-2xl">🎁</span> Bonus 35 points</h3><p className="text-gray-300 text-sm leading-relaxed">Si la somme de la partie supérieure (As à Six) fait <strong>63 points ou plus</strong>.</p></div>
                    </div>
                </div>
              ...
              {players.length===2&&isGameStarted()&&!editMode&&(()=>{
                ...
                return <div className="mb-4 px-1">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="text-left">
                        ...
                        <div className={"font-black transition-all duration-700 "+(leader===0?"text-3xl":"text-2xl text-gray-400")} style={{color:leader===0?pc1.hex:'',fontFamily:'JetBrains Mono',textShadow:leader===0?`0 0 20px ${pc1.hex}60`:'',transform:leader===0?'scale(1.05)':'scale(0.95)'}}>{t1}</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="text-right">
                        ...
                        <div className={"font-black transition-all duration-700 "+(leader===1?"text-3xl":"text-2xl text-gray-400")} style={{color:leader===1?pc2.hex:'',fontFamily:'JetBrains Mono',textShadow:leader===1?`0 0 20px ${pc2.hex}60`:'',transform:leader===1?'scale(1.05)':'scale(0.95)'}}>{t2}</div>
                      </div>
                  ...
                  <div className={"h-4 rounded-full overflow-hidden flex border "+(isClose?"border-red-500/40":"border-white/10")} style={{background:'rgba(255,255,255,0.05)'}}>
                    <div className="h-full rounded-l-full transition-all duration-1000 ease-out relative overflow-hidden" style={{width:pct1+'%',background:`linear-gradient(90deg,${pc1.hex},${pc1.hex}bb)`,boxShadow:`0 0 ${gap<=10?'12':'6'}px ${pc1.hex}${leader===0?'80':'30'}`}}>
                    ...
                    <div className="h-full rounded-r-full transition-all duration-1000 ease-out relative overflow-hidden flex-1" style={{background:`linear-gradient(90deg,${pc2.hex}bb,${pc2.hex})`,boxShadow:`0 0 ${gap<=10?'12':'6'}px ${pc2.hex}${leader===1?'80':'30'}`}}>
